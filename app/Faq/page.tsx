                    ...
                    <div className=' flex'>
                        <div className=' w-1/4   p-2 m-2 ' >
                            <ul className='flex flex-col p-2 m-2'>
                                <li className='my-4'>
                                    <Link href='' onClick={() => scrolltoHash('Returns')} scroll={false}>
                                ...
                                <li className='my-4'>
                                    <Link href='' onClick={() => scrolltoHash('Delivery')} scroll={false}>
                                ...
                                <li className='my-4'>
                                    <Link href='' onClick={() => scrolltoHash('Standard')} scroll={false}>
