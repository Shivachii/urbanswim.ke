...
>
                          ...
                          <li className='m-2 '>
                              <Link href='/pages/contact' className='hover:cursor-pointer'
                              >
              ...
              <div className='relative lg:absolute bottom-0 right-0 p-4 mt-12 flex flex-row space-x-4 text-xl '>
                      ...
                      <Link
                          href='https://www.instagram.com/urbaneswim.ke?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=='
                          target='blank'
                          className='hover:cursor-pointer'
                          >
