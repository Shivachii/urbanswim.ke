    ...
    <main className="min-h-screen w-full">
      ...
      <div className="text-center p-4 sm:p-10">
        ...
        <p className="text-md sm:text-lg font-medium">
          Taking a dip this summer? Visit our shop and let us make your summer
          worthwhile.
        </p>
        <button
          type="button"
          className="m-4 bg-black text-white hover:opacity-80 rounded-3xl w-[150px] sm:w-[200px] h-[40px]"
        >
          Shop Now
        </button>
      </div>
