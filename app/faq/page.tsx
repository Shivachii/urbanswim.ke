      ...
      <div className=" flex">
        <div className=" w-1/4   p-2 m-2 ">
          <ul className="flex flex-col p-2 m-2">
            <li className="my-4">
              ...
              >
                <p className="hover:underline underline-offset-8 decoration-slate-400  hover:translate-x-2 duration-200">
        ...
        <div className="w-3/4 ">
          <div className="m-2 p-2" id="Returns">
            <h1 className="font-semibold text-xl">Returns and Exchanges</h1>
            <div>
              <Returns />
            </div>
          </div>
          <div className="m-2 p-2" id="Delivery">
            <h1 className="font-semibold text-xl">Delivery and Shipping</h1>
            <div>
              <Delivery />
            </div>
          </div>
          <div className="m-2 p-2" id="Standard">
            <h1 className="font-semibold text-xl">Standard Questions</h1>
            <div>
              <Standard />
            </div>
          </div>
